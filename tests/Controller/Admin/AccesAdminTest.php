...
final class AccesAdminTest extends WebTestCase
{
    ...
    public static function pagesAdmin(): iterable
    {
        $urls = [
            '/admin/',
            '/admin/licencies',
            '/admin/licencies/nouveau',
            '/admin/dirigeants',
            '/admin/dirigeants/nouveau',
            '/admin/import',
            '/admin/categories',
            '/admin/config',
            '/admin/config/saisons',
            '/admin/config/saisons/nouvelle',
            '/admin/config/utilisateurs',
            '/admin/config/utilisateurs/nouveau',
            '/admin/config/documents',
            '/admin/config/documents/nouveau',
            '/admin/profil',
            '/admin/documentation',
            '/admin/diagnostic',
            '/admin/club-house',
            '/admin/club-house/cles',
            '/admin/club-house/attestation',
            '/admin/club-house/attestation/apercu',
            '/admin/club-house/attestation/recapitulatif',
            '/admin/stock',
